...
import { apadrinados }from '../assets/barrido'; // Importa las imágenes desde el archivo de índice
...
const Gallery = () => {
  ...
  const handleShowMore = () => {
    setVisibleCount((prevCount) => Math.min(prevCount + INITIAL_COUNT, apadrinados.length));
  };
  ...
  return (
    <div>
      <GalleryContainer>
        {apadrinados.slice(0, visibleCount).map((image) => (
      ...
      {visibleCount < apadrinados.length && (
        <ButtonContainer>
